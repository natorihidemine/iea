...
<form action='/rooms/search' accept_sharset="UTF-8" method="get">
  ...
  <div> 路線・駅：&nbsp;&nbsp;東京メトロ銀座線&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 新橋駅">新橋&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 銀座駅">銀座&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 京橋駅">京橋&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 日本橋駅">日本橋&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 三越前駅">三越前</div><img src="/images/ienashiko.jpg"style="float:right;">
