...
<div >路線・駅：</div>
  ...
  &nbsp;&nbsp;都営地下鉄浅草線&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 東銀座駅">東銀座&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 宝町駅">宝町&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 日本橋駅">日本橋&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 人形町駅">人形町&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="stat[]" value="線 東日本橋駅">東日本橋<br>
